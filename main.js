...
function getZodiacObject(signString) {
    switch (signString) {
        case 'aquarius':
            return {
                doesWellWith: [['aquarius', 36], ['pisces', 5], ['aries', 10], ['taurus', 1], ['gemini', 10], ['cancer', 1], ['leo', 10], ['virgo', 1], ['libra', 10], ['scorpio', 5], ['sagittarius', 10], ['capricorn', 1]],
                doesNotDoWellWith: [['aquarius', 0], ['pisces', 0], ['aries', 0], ['taurus', 0], ['gemini', 0], ['cancer', 0], ['leo', 0], ['virgo', 0], ['libra', 0], ['scorpio', 0], ['sagittarius', 0], ['capricorn', 0]],
        ...
        case 'pisces':
            return {
                doesWellWith: [['aquarius', 0], ['pisces', 0], ['aries', 0], ['taurus', 0], ['gemini', 0], ['cancer', 0], ['leo', 0], ['virgo', 0], ['libra', 0], ['scorpio', 0], ['sagittarius', 0], ['capricorn', 0]],
                doesNotDoWellWith: [['aquarius', 0], ['pisces', 0], ['aries', 0], ['taurus', 0], ['gemini', 0], ['cancer', 0], ['leo', 0], ['virgo', 0], ['libra', 0], ['scorpio', 0], ['sagittarius', 0], ['capricorn', 0]],
